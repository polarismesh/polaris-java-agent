...
public class DefaultInterceptorDefinition implements InterceptorDefinition {
    ...
    public DefaultInterceptorDefinition(Class<? extends Interceptor> baseInterceptorClazz,
            Class<? extends Interceptor> interceptorClazz, InterceptorType interceptorType, CaptureType captureType,
