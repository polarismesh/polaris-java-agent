...
import cn.polarismesh.agent.plugin.dubbox.polaris.loadbalance.LoadBalanceFactory;
import cn.polarismesh.agent.plugin.dubbox.polaris.loadbalance.PolarisAbstractLoadBalance;
import cn.polarismesh.agent.plugin.dubbox.utils.ReflectUtil;
import cn.polarismesh.agent.plugin.dubbox.constants.DubboConstants;
...
public class DubboLoadBalanceInterceptor implements AbstractInterceptor {
    ...
    /**
     * 在ExtensionLoader的getExtension()方法前进行拦截
    ...
    public void after(Object target, Object[] args, Object result, Throwable throwable) {
        ...
        if (!DubboConstants.DUBBO_LOADBALANCES.contains(name)) {
            return;
        }
        LOGGER.info("loadbalance: {}", result.getClass());
    }
}
