...
/**
 * 自定义 NacosNamingHttpClientProxy
 *
 * @author bruceppeng
 */
public class NacosNamingHttpClientProxy extends NamingHttpClientProxy {
    ...
    public NacosNamingHttpClientProxy(String namespaceId, SecurityProxy securityProxy, ServerListManager serverListManager,
            Properties properties, ServiceInfoHolder serviceInfoHolder) {
        super(namespaceId, securityProxy, serverListManager, properties, serviceInfoHolder);
