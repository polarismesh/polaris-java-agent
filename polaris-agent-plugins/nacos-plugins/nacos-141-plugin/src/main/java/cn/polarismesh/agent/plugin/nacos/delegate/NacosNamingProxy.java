...
public class NacosNamingProxy extends NamingProxy {
    ...
    public String queryList(String serviceName, String clusters, int udpPort, boolean healthyOnly)
        ...
        try {
            secondResult = callServerForTarget(api, params, Collections.EMPTY_MAP, HttpMethod.GET);
        } catch (Exception exp) {
    ...
    private String mergeResult(String result, String secondResult) {
        ...
        try {
            ...
            NAMING_LOGGER.error("NacosNamingProxy mergeResult request {} failed.", this.otherNacosDomain, exp);
        }
        return result;
    ...
    private String callServerForTarget(String api, Map<String, String> params, Map<String, String> body,
        ...
        for (int i = 0; i < maxRetry; i++) {
            try {
                //1.请求目标nacos server
                return callServer(api, params, body, this.otherNacosDomain, method);
            } catch (NacosException e) {
                if (NAMING_LOGGER.isDebugEnabled()) {
                    NAMING_LOGGER
                            .debug("NacosNamingProxy callServerForTarget request {} failed.", this.otherNacosDomain,
                                    e);
                }
            }
        }
