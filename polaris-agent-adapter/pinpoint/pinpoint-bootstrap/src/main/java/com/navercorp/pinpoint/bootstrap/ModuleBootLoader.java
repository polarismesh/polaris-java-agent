...
public class ModuleBootLoader {
    ...
    public ModuleBootLoader(Instrumentation instrumentation, ClassLoader parentClassLoader) {
    ...
    public void loadModuleSupport() {
        try {
            ...
            Method newModuleSupportMethod = moduleSupportFactory.getClass()
                    .getMethod("newModuleSupport", Instrumentation.class);
    ...
    void defineAgentModule(ClassLoader classLoader, URL[] jarFileList) {
        ...
        try {
            Method definePinpointPackage = this.moduleSupport.getClass()
                    .getDeclaredMethod("defineAgentModule", ClassLoader.class, URL[].class);
    ...
    private Class<?> getModuleSupportFactoryClass(ClassLoader parentClassLoader) {
        try {
            return Class.forName("com.navercorp.pinpoint.bootstrap.java9.module.ModuleSupportFactory", false,
                    parentClassLoader);
